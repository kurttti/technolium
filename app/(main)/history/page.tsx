      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        >
          ...
          <p>
            ...
            Так перешел на Python. Само образование не сильно помогло в заработке, рынок труда был жестким, 
          ...
          <p>
            Назар говорит: "Арсений мне напоминает, что я теперь до мозга костей. Когда Сеня тоже начинал разработку, 
            но пошел на бизнес-аналитика. Он более предприимчивый и коммуникабельный. Мы хоть и братья, но очень разные, 
            он больше про бизнес-процессы, а у меня задачи, где нужно копать вглубь: оптимизация запросов, настройка 
            мониторинга через Grafana, интеграция и микросервисы."
          </p>
          <p>
            ...
            карьеру: сначала как системный аналитик, потом перешел в управление на СПбГЭУ.
          </p>
          <p>
        ...
        >
          ...
          <p className="text-lg mb-4">
            ...
            Все ребята дошли до конца и получили свои первые работы. Это было просто: за 2 месяца проверить программу и 
        ...
        >
          ...
          <p className="text-lg mb-4">
            Мы не хотим конкурировать за звание самого огромного университета на рынке, нет цели влезать в космос и становится 
            одной из самых громких школ на рынке. Нас интересует сделать прыжок в сторону упора на качество обучения.
          </p>
          <p className="text-lg">
            Также есть запросы от компаний, для которых Назар и Арсений выполняли проекты. Поэтому для студентов будет помощь 
            в трудоустройстве и рекомендации от наших преподавателей. Сейчас весь фокус внимания на главную цель - это 5000-10000 
            студентов, которым мы поможем получить достойный заработок и новую жизнь.
          </p>
        </motion.div>
      </div>
    </div>

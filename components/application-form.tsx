...
export function ApplicationForm({ isOpen, onClose, selectedPlan }: ApplicationFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]" onClick={handleClose}>
      <div
        className="bg-white p-8 max-w-md w-full m-4 max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-[24px] text-[#1B324A] font-bold">{selectedPlan ? planTitles[selectedPlan] : "Оставить заявку"}</h2>

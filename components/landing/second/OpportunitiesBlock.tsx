      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white rounded-[20px] p-6 md:p-12 border border-black">
            <h3 className="text-[24px] md:text-[32px] mb-6 md:mb-8 leading-tight break-words hyphens-auto" style={{ fontFamily: 'BOWLER' }}>
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center gap-4 mb-6 md:mb-8">
              <div className="bg-[#1E1B4B] text-white px-4 py-2 rounded text-sm md:text-base shrink-0">
                -55 %
              </div>
              <div className="text-xl md:text-2xl break-words hyphens-auto" style={{ fontFamily: 'BOWLER' }}>
                ОТ ОБЩЕЙ СТОИМОСТИ
              </div>
            </div>

            <p className="text-sm md:text-base text-gray-700 mb-8 md:mb-12 break-words hyphens-auto">
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                <h4 className="text-xl md:text-2xl mb-3 md:mb-4 leading-tight break-words hyphens-auto" style={{ fontFamily: 'BOWLER' }}>
                  ПРОФОРИЕНТАЦИЯ
                </h4>

    ...
    <section className="w-full min-h-screen flex items-center justify-center bg-white px-4 sm:px-6 md:px-8 pb-8 sm:pb-12 md:pb-16 lg:pb-20">
      <div className="max-w-content w-full flex flex-col items-center">
        ...
        <div className="bg-[#F8F8F8] rounded-[20px] sm:rounded-[24px] md:rounded-[28px] lg:rounded-[32px] shadow-xl w-full flex flex-col lg:flex-row items-center justify-between p-6 px-12 gap-6 sm:gap-8 md:gap-12 lg:gap-24">
          <div className="w-full lg:w-1/2 h-[300px] sm:h-[500px] md:h-[500px] lg:h-[600px] bg-black rounded-[16px] sm:rounded-[20px] md:rounded-[24px] overflow-hidden flex items-center justify-center">
          ...
          <div className="flex-1 lg:w-1/2 min-h-[300px] sm:min-h-[200px] md:min-h-[300px] lg:h-[700px] flex flex-col w-full">

  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-white px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="max-w-content w-full flex flex-col items-center">
        ...
        <div className="bg-white rounded-[20px] sm:rounded-[24px] md:rounded-[28px] lg:rounded-[32px] shadow-xl w-full flex flex-col lg:flex-row items-center justify-between p-4 sm:p-6 md:p-8 lg:p-12 gap-6 sm:gap-8 md:gap-12 lg:gap-24">
